...
if(isset($_GET["id_nome_link"])){
    ...
    $sql_select = "SELECT * FROM mensagem_contato WHERE id = '$id_nome'";
...
if(isset($_POST['confirmar'])){
    ...
    if ($_POST['confirmar'] == "Confirmar") {
        ...
        $sql_delete = "DELETE FROM mensagem_contato WHERE id = '$id_nome'";
        ...
        if(isset($retorno) && $retorno) {
            ...
            echo "<script type='text/javascript'>alert('$mensagem'); window.location.href = 'contato.php';</script>";
    ...
    <div id="quadro">
            ...
            <form action="" method="post">
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" value="<?php if(isset($nome_alterar)) echo $nome_alterar["nome_usuario"];else{echo "Sem nome para deletar";} ?>">
                </div>
                <br>
                <br>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" value="<?php if(isset($nome_alterar)) echo $nome_alterar["mensagem"];else{echo "Sem mensagem para deletar";} ?>">
                </div>
                <!-- Botão de confirmação -->
                <input type="submit" class="botao-gradient" name="confirmar" value="Confirmar">
                <a class="botao-gradient" href="consultar_contato.php">Voltar</a>
            </form>
        </div>
    </div>
