...
if(isset($_GET["id_nome_link"])){
    ...
    $sql_select = "SELECT * FROM cadastro_professor WHERE id = '$id_nome'";
...
if(isset($_POST['confirmar'])){
    ...
    if ($_POST['confirmar'] == "Confirmar") {
        ...
        $sql_delete = "DELETE FROM cadastro_professor WHERE id = '$id_nome'";
        ...
        if(isset($retorno) && $retorno) {
            ...
            echo "<script type='text/javascript'>alert('$mensagem'); window.location.href = 'cadastro_professor.php';</script>";
...
<body class="light-theme">
    ...
    <div id="quadro">
            ...
            <form action="" method="post">
                <div class="mb-3">
                    <label class="form-label" for="">Nome completo do Professor:</label>
                    <input class="form-control" type="text" value="<?php if(isset($nome_alterar)) echo $nome_alterar["nome_professor"];else{echo "Sem nome para deletar";} ?>">
                </div>
                <br>
                <br>
                <div class="mb-3">
                    <label class="form-label" for="">Disciplina:</label>
                    <input class="form-control" type="text" value="<?php if(isset($nome_alterar)) echo $nome_alterar["ndiciplina"];else{echo "Sem disciplina para deletar";} ?>"> 
                </div>
                <br>
                <br>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" value="<?php if(isset($nome_alterar)) echo $nome_alterar["endereco"];else{echo "Sem endereço para deletar";} ?>">
                </div>
                <br>
                <br>
                <div class="mb-3">
                    <label class="form-label" for="">Telefone:</label>
                    <input class="form-control" type="text" value="<?php if(isset($nome_alterar)) echo $nome_alterar["telefone"];else{echo "Sem telefone para deletar";} ?>">
                </div>
                <div class="mb-3">
                ...
                <a class="botao-gradient" href="consultar_professor.php">Voltar</a>
            </form>
        </div>
    </div>
