...
<div id="quadro" class="container text-center">
    <h1>Edite o seu cadastro professor!</h1>
 
    <form action="" method="post">
        <div class="mb-3">
            <label class="form-label" for="">Nome completo :</label>
            <input class="form-control" type="text" name="bt_professor" value="<?php if(isset($_GET["id_nome_link"])){echo $nome_alterar["professor"];}else{echo "Sem nome para editar";} ?>">
        </div>
        <br>
        <br>
        <div class="mb-3">
            <label class="form-label" for="">Disciplina:</label>
            <input class="form-control" type="text" name="bt_diciplina" value="<?php if(isset($_GET["id_nome_link"])){echo $nome_alterar["diciplina"];}else{echo "Sem diciplina para editar";} ?>">
        </div>
        <br>
        <br>
        <div class="mb-3">
       ...
       <div class="mb-3">
            ...
            <input class="form-control" type="text" name="bt_endereco" value="<?php if(isset($_GET["id_nome_link"])){echo $nome_alterar["endereco"];}else{echo "Sem endereço para editar";} ?>">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <a class="btn btn-primary" href="consultar_professor.php">Consultar</a>
        </div>
     </form>
    </div>
</body>
