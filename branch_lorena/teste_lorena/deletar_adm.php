...
if(isset($_GET["id_nome_link"])){
    ...
    $sql_select = "SELECT * FROM tabela_adm WHERE id = '$id_nome'";
...
if(isset($_POST['confirmar'])){
    ...
    if ($_POST['confirmar'] == "Confirmar") {
        ...
        $sql_delete = "DELETE FROM tabela_adm WHERE id = '$id_nome'";
        ...
        if(isset($retorno) && $retorno) {
            ...
            echo "<script type='text/javascript'>alert('$mensagem'); window.location.href = 'cadastrar_adm.php';</script>";
...
<body class="light-theme">
    ...
    <div id="quadro">
            ...
            <form action="" method="post">
                <div class="mb-3">
                    <label class="form-label" for="">Nome completo do Administrador:</label>
                    <input class="form-control" type="text" value="<?php if(isset($nome_alterar)) echo $nome_alterar["adm"];else{echo "Sem nome para deletar";} ?>">
                </div>
                <br>
                <br>
                <div class="mb-3">
