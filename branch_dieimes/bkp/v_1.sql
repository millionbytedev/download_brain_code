...
--
-- Host: localhost:3306
-- Tempo de geração: 03/04/2024 às 14:33
...
CREATE TABLE `pi_2024_braincode_professor` (
  ...
  `disciplina` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
...
(1, 'Rosangela Cristina', 'Sem disciplina', 'cristinarosan@gmail.com', 'AV. Maranhão', '12345', '1234'),
(2, 'Rodrigo Oliveira', 'Sem disciplina', 'rodrigooliveira@gmail.com', 'Rua Mauá', '12345', '1234'),
(3, 'Diego da Silva', 'Sem disciplina', 'diegosilva@gmail.com', 'Rua José Fuzer', '12345', '1234'),
(4, 'Andressa Nogueira', 'Sem disciplina', 'andressanog@gmail.com', 'Rua Diva Proença ', '12345', '1234'),
(5, 'Natália Gomes', 'Sem disciplina', 'nataliames@gmail.com', 'AV. Paulista', '12345', '1234'),
(6, 'Amélia Lourenço', 'Sem disciplina', 'amelialou@gmail.com', 'Rua Sete de Setembro', '12345', '1234'),
(7, 'Cláudio Rodrigues', 'Sem disciplina', 'claudiorodrigues@gmail.com', 'Rua Engenheiros Rebouças', '12345', '1234');
