<?php
    ...
    $sql_consultar_aluno = "SELECT * FROM pi_2024_braincode_aluno";
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-warning" href="editar_aluno.php?id_aluno=<?php echo $linha['id'];?>">EDITAR</a>
                        </td>
                        <td>
                            <a class="btn btn-danger" href="deletar_aluno.php?id_aluno=<?php echo $linha['id'];?>">DELETAR</a>
                        </td>
                    </tr>
                <?php
                    }
