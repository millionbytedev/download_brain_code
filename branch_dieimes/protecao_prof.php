...
if (!isset($_SESSION['nome_prof']) && !isset($_SESSION['nome_adm'])) {
    ...
    echo '<div style="background-color: #f8d7da; color: #721c24; padding: 10px; text-align: center; font-weight: bold;">
        Acesso negado: Você não pode acessar esta página porque não está logado como professor ou administrador. <a href="login.php" style="color: #721c24; font-weight: bold; text-decoration: underline;">Clique aqui para entrar</a>.
    </div>';
